	...
	<div class="introduc">
		<div class="introduc-content">
			...
			<div class="introduc-logo">
				<div>TẤT CẢ CÁC SẢN PHẨM ĐỀU ĐƯỢC THIẾT KẾ VÀ SẢN XUẤT BỞI PRISTINE</div>
				<a href="${base }"> <img src="${base }/img/logo.jpg" width="30%">
				</a>
			</div>
		</div>
		...
		<div class="introduc-contact">
			...
			<div class="introduc-list">
				<ul>
					<li><i class="fas fa-map-marker-alt"></i> Tòa Indochina, Dịch Vọng Hậu, Cầu Giấy, Hà Nội.</li>
					<li><i class="fas fa-phone-volume"></i> 0968769276</li>
					<li><i class="fas fa-phone-volume"></i> 0382556065</li>
					<li><i class="fas fa-paper-plane"></i> pristine@gmail.com
					</li>
				</ul>
			</div>
		</div>
