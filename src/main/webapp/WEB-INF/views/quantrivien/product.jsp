                    ...
                    <div style="display: flex; padding-right: 15px">
                        ...
                        <select class="form-control" name="categoryId" id="categoryId"
                            ...
                            <c:forEach items="${categories}" var="category">
                                <c:choose>
                                    <c:when test="${category.id == searchModel.categoryId}">
                        ...
                        <button type="submit" id="btnSearch" name="btnSearch"
                                value="Tìm kiếm" class="btn btn-flat btn-outline-secondary mb-3">Tìm kiếm
                        </button>
                    </div>
                    <div>
                        <button type="button"
                        ...
                        <c:forEach items="${productsWithPaging.data}" var="product"
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary"
                                       href="${base }/admin/product/add-product/${product.id}" role="button">Chỉnh sửa</a>
                                    <a class="btn btn-danger" role="button"
                                       href="${base }/delete/${product.id}">Xóa</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
